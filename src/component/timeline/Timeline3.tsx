...
// const code = `
// <div className="backdrop-blur-sm rounded overflow-x-auto h-[32rem] w-[17.5rem] tablet:w-[40rem] bigtablet:w-[50rem] laptop:w-100rem grid place-items-center px-2 ">
